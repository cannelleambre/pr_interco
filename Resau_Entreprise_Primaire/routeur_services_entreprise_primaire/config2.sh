...
ip addr add 120.0.82.253/25 dev eth0  # Réseau primaire2
ip addr add 120.0.83.127/25 dev eth1  #  Réseau primaire1
ip addr add 120.0.83.137/25 dev eth2  # Réseau services 
